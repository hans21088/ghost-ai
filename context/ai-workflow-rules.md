...
<!-- 
  The AI workflow rules keep the agent disciplined, defining how to scope work and what to do when something needs a decision.
  It's not about what we are building. It's about how the agent behaves when building it.
-->

## Approach

Build this project incrementally using a spec-driven workflow. Context files define what to build, how to build it, and what the
current state of progress is. Always implement against these specs - do not infer or invent behavior from scratch.
...
Project-specific styling, layout changes, and feature logic must be implemented in app-level components instead of modifying
