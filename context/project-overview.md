# Ghost AI
<!-- 
What the product is, who is it for, the core flows, and what deliberatedly out of the scope.

The way through is to learn the kind of thinking that AI cannot replace.
Tools: Next.js, React 19, 
       Liveblocks : real-time collaboration with agents,
       Trigger.dev: background work with AI agents,
       Clerk : auth and user management,
       Prisma and Postgres : data,
       Vercel Blob : storage,
-->
