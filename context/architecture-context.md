...
<!-- 
    The architecture file defines the tech stack, the boundaries between alyers, and the invariants the codebase must never break. The code standards keeps the agent consistent across every unit of the build with shared Typescript and Next.js conventions.
-->
